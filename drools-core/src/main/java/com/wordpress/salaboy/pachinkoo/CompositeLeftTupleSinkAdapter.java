...
public class CompositeLeftTupleSinkAdapter implements LeftTupleSinkPropagator {
    ...
    protected void doPropagateAssertLeftTuple( PropagationContext context, LeftTupleSink sink, LeftTuple leftTuple, WorkingMemory wm ) {
    ...
    protected void doPropagateAssertLeftTuple( PropagationContext context, LeftTupleSink sink, LeftTuple leftTuple, RightTuple rightTuple, WorkingMemory wm ) {
