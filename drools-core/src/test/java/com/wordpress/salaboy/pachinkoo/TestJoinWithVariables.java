...
public class TestJoinWithVariables {
    ...
    public void joinNodeTest() {
        ...
        // final JoinNode joinNode = new JoinNode(new
        // SingleValueRestrictionConstraint("Person.favouriteCheese",
        // "Cheese.name", COMPARATOR.EQUAL));
        final JoinNode joinNode = new JoinNode(
            new SingleValueRestrictionConstraint( new FieldRestriction( Person.class, "favoriteCheese" ), new FieldVariable( "$cheddar" ), COMPARATOR.EQUAL ) );
